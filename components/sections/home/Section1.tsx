...
export default function Section1() {
    return (
        <>
            ...
            <section className="ai-solutions-home-section-1 position-relative overflow-hidden pt-50 pb-250">
                ...
                <div className="container position-relative z-1">
                    <div className="row align-items-center">
                        <div className="col-10 mx-auto">
                            <h1 className="text-white  mb-0 text-anime-style-2">Global </h1>
                            <h1 className="text-white  mb-0 text-anime-style-2"> Encounters</h1>
                            <h1 className="text-white  mb-0 text-lg-end text-anime-style-1">2025 Dubai</h1>
                            <h1 className="text-white  mb-0 text-lg-end text-anime-style-1">Team Kenya</h1>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-lg-6 mx-auto mt-5">
                            <form className="input-group mb-3 mt-4 position-relative" data-aos="zoom-in" data-aos-delay={100}>
                                <input type="text" className="py-3 form-control generate rounded-start-4 border-end-0 border-primary" name="name" placeholder="Search by event or name" />
